...
const SessionsRequests = () => {
  const sessions = [
    { id: '#CM9801', counselor: 'Natali Craig', avatar: 'NC', topic: 'Essay writing', date: 'Just now', status: 'Join Meet', statusType: 'join' },
    { id: '#CM9802', counselor: 'Kate Morrison', avatar: 'KM', topic: 'Essay writing', date: 'A minute ago', status: 'Upcoming', statusType: 'upcoming' },
    { id: '#CM9803', counselor: 'Drew Cano', avatar: 'DC', topic: 'Essay writing', date: '1 hour ago', status: 'Upcoming', statusType: 'upcoming' },
    { id: '#CM9804', counselor: 'Orlando Diggs', avatar: 'OD', topic: 'Essay writing', date: 'Yesterday', status: 'Upcoming', statusType: 'upcoming' },
    { id: '#CM9805', counselor: 'Andi Lane', avatar: 'AL', topic: 'Essay writing', date: 'Feb 2, 2023', status: 'Upcoming', statusType: 'upcoming' },
    { id: '#CM9801', counselor: 'Natali Craig', avatar: 'NC', topic: 'Essay writing', date: 'Just now', status: 'Upcoming', statusType: 'upcoming' },
    { id: '#CM9802', counselor: 'Kate Morrison', avatar: 'KM', topic: 'Essay writing', date: 'A minute ago', status: 'Upcoming', statusType: 'upcoming' },
    { id: '#CM9803', counselor: 'Drew Cano', avatar: 'DC', topic: 'Essay writing', date: '1 hour ago', status: 'Upcoming', statusType: 'upcoming' },
    { id: '#CM9804', counselor: 'Orlando Diggs', avatar: 'OD', topic: 'Essay writing', date: 'Yesterday', status: 'Pending', statusType: 'pending' },
    { id: '#CM9805', counselor: 'Andi Lane', avatar: 'AL', topic: 'Essay writing', date: 'Feb 2, 2023', status: 'Pending', statusType: 'pending' },
  ]
              ...
              <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                ...
                <td className="py-2 sm:py-3 px-2 sm:px-4">
                  <div className="flex items-center gap-2">
                    <div className={`w-2 h-2 ${getStatusColor(session.statusType)} rounded-full`}></div>
                    {session.statusType === 'join' ? (
                      <button className="bg-blue-500 text-white px-3 py-1 rounded-lg text-xs font-medium hover:bg-blue-600 transition-colors">
                        {session.status}
                      </button>
                    ) : (
